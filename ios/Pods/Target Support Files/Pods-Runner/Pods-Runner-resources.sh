...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/geocoding_ios/geocoding_ios_privacy.bundle"
  ...
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/share_plus/share_plus_privacy.bundle"
