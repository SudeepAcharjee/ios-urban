...
import '../features/shop/views/shop_main_screen.dart';
import '../features/shop/views/shop_onboarding_screen.dart';
import '../features/shop/views/shop_waiting_approval_screen.dart';
      ...
      if (mounted) {
        ...
        if (user != null) {
          ...
          try {
            ...
            var shopDoc = await FirebaseFirestore.instance.collection('shops').doc(uid).get();
            bool isShop = shopDoc.exists;

            var doc = isShop ? shopDoc : await FirebaseFirestore.instance.collection('workers').doc(uid).get();
            ...
            if (data == null) {
              ...
              // Workers are considered complete if they have name and phone (phoneVerified only required if kRequirePhoneVerification is true)
              // Users also need gender
              ...
              final bool hasProfile = isWorkerRole 
                  ? (data['name'] != null && data['phone'] != null && hasPhoneVerified)
                  : ((hasNameAndPhone || data['gender'] != null) && hasPhoneVerified);
