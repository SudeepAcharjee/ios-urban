  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final profileItems = [
      ...
      _ProfileItemConfig(
        ...
        subtitle: 'Manage active plan & auto-bookings',
        iconColor: const Color(0xFF2029C5), // Royal Blue
        bgColor: const Color(0xFFEFF6FF), // Light Blue
      ...
      _ProfileItemConfig(
        ...
        title: 'Refer & Earn',
        subtitle: 'Invite friends & both get 10% OFF',
        ...
        data: (userData) {
          ...
          return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, subSnap) {
              final bool isSubscribed = subSnap.data?.docs.isNotEmpty == true;
              final subData = isSubscribed ? subSnap.data!.docs.first.data() : null;
              final planName = subData?['planName']?.toString() ?? 'VIP Member';
                        ...
                        gradient: isSubscribed
                            ? const LinearGradient(
                                colors: [
                                  ...
                                  Color(0xFF1E3A8A), // Royal Imperial Blue
                                  Color(0xFF2563EB), // Electric Blue Glow
                                ],
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                if (isSubscribed) ...[
                                                  const Icon(Icons.auto_awesome, color: Color(0xFFFBBF24), size: 12),
